...
import java.util.List;
    ...
    private IArCustomersService service;
        ...
        @RequestMapping(value = "/hap/ar/customers/getName")
        @ResponseBody
        public ResponseData getName(OrgCompanys dto, @RequestParam Long customerId, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
                                    @RequestParam(defaultValue = DEFAULT_PAGE_SIZE) int pageSize, HttpServletRequest request) {
            return new ResponseData(service.getName(customerId));
        }
